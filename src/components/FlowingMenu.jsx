...
function MenuItem({ link, text, image, subItems, speed, textColor, marqueeBgColor, marqueeTextColor, borderColor }) {
  ...
  useEffect(() => {
    const calculateRepetitions = () => {
      ...
      // Add extra padding to repetitions to ensure no empty space
  ...
  }, [text, image, subItems, repetitions, speed]);
